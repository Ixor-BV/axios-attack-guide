...
curl -sL https://raw.githubusercontent.com/Ixor-BV/axios-attack-guide/main/check.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/Ixor-BV/axios-attack-guide/main/check.ps1 | iex
```

Or clone and run locally:
```bash
git clone https://github.com/Ixor-BV/axios-attack-guide.git
